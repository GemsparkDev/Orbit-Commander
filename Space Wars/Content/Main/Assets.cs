...
public static class Assets
{
    ...
    public static void LoadAssets(ContentManager Content)
    {
        ...
        Sprites.Add(Sprite.Furnace, Content.Load<Texture2D>("Images/Entity_47"));
        Sprites.Add(Sprite.RealFurnace, Content.Load<Texture2D>("Images/UI_39"));
        ...
        Sprites.Add(Sprite.RealTorch, Content.Load<Texture2D>("Images/Item_8-1"));
        Sprites.Add(Sprite.Assault, Content.Load<Texture2D>("Images/Item_9"));
        Sprites.Add(Sprite.RealAssault, Content.Load<Texture2D>("Images/Item_9-1"));
        Sprites.Add(Sprite.Shield, Content.Load<Texture2D>("Images/Item_10"));
        Sprites.Add(Sprite.RealShield, Content.Load<Texture2D>("Images/Item_10-1"));
        Sprites.Add(Sprite.Lidar, Content.Load<Texture2D>("Images/Item_11"));
        Sprites.Add(Sprite.RealLidar, Content.Load<Texture2D>("Images/Item_11-1"));
        Sprites.Add(Sprite.Nanomachines, Content.Load<Texture2D>("Images/Item_12"));
        Sprites.Add(Sprite.RealNanomachines, Content.Load<Texture2D>("Images/Item_12-1"));
        Sprites.Add(Sprite.Expose, Content.Load<Texture2D>("Images/Item_13"));
        Sprites.Add(Sprite.RealExpose, Content.Load<Texture2D>("Images/Item_13-1"));
        Sprites.Add(Sprite.Stealth, Content.Load<Texture2D>("Images/Item_14"));
        Sprites.Add(Sprite.RealStealth, Content.Load<Texture2D>("Images/Item_14-1"));
        Sprites.Add(Sprite.Radar, Content.Load<Texture2D>("Images/Item_15"));
        Sprites.Add(Sprite.RealRadar, Content.Load<Texture2D>("Images/Item_15-1"));
        Sprites.Add(Sprite.GrapplingHook, Content.Load<Texture2D>("Images/Item_16"));
        Sprites.Add(Sprite.RealGrapplingHook, Content.Load<Texture2D>("Images/Item_16-1"));
        Sprites.Add(Sprite.Fireball, Content.Load<Texture2D>("Images/Item_17"));
        Sprites.Add(Sprite.RealFireball, Content.Load<Texture2D>("Images/Item_17-1"));
        Sprites.Add(Sprite.PrismArray, Content.Load<Texture2D>("Images/Item_18"));
        Sprites.Add(Sprite.RealPrismArray, Content.Load<Texture2D>("Images/Item_18-1"));
