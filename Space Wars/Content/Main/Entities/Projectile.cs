...
using static Space_Wars.Content.Main.Entities.GrapplingHook;
...
public class Projectile : Entity
{
    ...
    public static Projectile NewSpiralShot(Vector2 _position, Vector2 _velocity, float _angle, float _angularVelocity, bool _isFriendly, int _damage, float _offset, int _stealth = 0)
    {
        var shot = new Projectile(Assets.Get(Sprites.SpiralShot), _position, _velocity, _angle, _angularVelocity, _isFriendly, _damage, _stealth);
        var behaviour = new Behaviour(shot);
    ...
    public static Projectile NewAssassinShot(Vector2 _position, Vector2 _velocity, float _angle, float _angularVelocity, bool _isFriendly, int _damage, int _stealth = 0)
    {
        var shot = new Projectile(Assets.Get(Sprites.Microshot), _position, _velocity, _angle, _angularVelocity, _isFriendly, _damage, _stealth);
        var behaviour = new Behaviour(shot);
    ...
    public static Projectile NewExplosive(Vector2 _position, Vector2 _velocity, float _angle, float _angularVelocity, bool _isFriendly, int _damage, float _radius, int _stealth = 0)
    {
        var shot = new Projectile(Assets.Get(Sprites.Explosive), _position, _velocity, _angle, _angularVelocity, _isFriendly, _damage, _stealth);
        var behaviour = new Behaviour(shot);
    ...
    public static Projectile NewSpewer(Vector2 _position, Vector2 _velocity, float _angle, float _angularVelocity, bool _isFriendly, int _damage, int _stealth = 0)
    {
        var shot = new Projectile(Assets.Get(Sprites.Explosive), _position, _velocity, _angle, _angularVelocity, _isFriendly, _damage, _stealth);
        var behaviour = new Behaviour(shot);
    ...
    public static Projectile NewSplitter(Vector2 _position, Vector2 _velocity, float _angle, bool _isFriendly, int _damage, List<Entity> _splits, float _cooldown = 1, int _stealth = 0, bool _targetting = false)
    {
        var shot = new Projectile(Assets.Get(Sprites.Explosive), _position, _velocity, _angle, 0, _isFriendly, _damage, _stealth);
        var behaviour = new Behaviour(shot);
