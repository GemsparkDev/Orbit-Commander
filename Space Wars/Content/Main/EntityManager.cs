...
public class EntityManager
{
    ...
    [
        ...
        [],
        "???",
        "", -1, new Vector2(-2000, -2000), 0, 1, null, true) { playerDocked = true, music = false, relaunchable = true },
        ...
        "Warp Gate", "Warp to the next mission once you are done here", -1, new Vector2(0, 500)) { music = false, tip = "Press left shift to return to the previous system. Press right shift to enter the next system.", relaunchable = true },
        ...
        0, 0, null, true) { relaunchable = true },
        ...
        "Binary system", "Construct the Mass Relay.", 0.5f, new Vector2(0, 400), 0, 2, null, true) { isAggressive = true },
