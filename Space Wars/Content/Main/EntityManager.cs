...
public class EntityManager
{
    ...
    private static ICollider[] BlackHoleStation() => [
        new ArcCollider(new Vector2(0,0),2.0943952f,0,250),
new ArcCollider(new Vector2(0,0),0.7853982f,3.1415927f,125),
new ArcCollider(new Vector2(0,0),3.0106928f,1.5707964f,400),
new ArcCollider(new Vector2(0,0),3.0106928f,-1.5707964f,400),
...
new LineCollider(new Vector2(50,-550), new Vector2(50,-500)),
new LineCollider(new Vector2(50,-450), new Vector2(50,-400)),
new LineCollider(new Vector2(-100,-550), new Vector2(-400,-550)),
new LineCollider(new Vector2(-400,-550), new Vector2(-400,-925)),
new LineCollider(new Vector2(-50,-400), new Vector2(-50,-450)),
new LineCollider(new Vector2(-50,-550), new Vector2(-50,-500)),
new LineCollider(new Vector2(-400,-550), new Vector2(-400,-400)),
    ];
}
