...
public class EntityManager
{
    ...
    private static ICollider[] BlackHoleStation() => [
        ...
        new ArcCollider(new Vector2(0, 0), MathF.PI * 23/24, MathF.PI/2, 400),
        new ArcCollider(new Vector2(0, 0), MathF.PI * 23/24, -MathF.PI/2, 400),
        new LineCollider(new Vector2(50,-400), new Vector2(400,-400)),
        new LineCollider(new Vector2(400,-400), new Vector2(400,0)),
        new LineCollider(new Vector2(50,-400), new Vector2(50,-550)),
        new LineCollider(new Vector2(25,-550), new Vector2(50,-550)),
        new LineCollider(new Vector2(-50,-400), new Vector2(-50,-550)),
        new LineCollider(new Vector2(-25,-550), new Vector2(-50,-550)),
        new LineCollider(new Vector2(-50,-400), new Vector2(-400,-400)),
        new LineCollider(new Vector2(-400,-400), new Vector2(-400,0)),
        new LineCollider(new Vector2(-400,0), new Vector2(-400,400)),
        new LineCollider(new Vector2(-400,400), new Vector2(-50,400)),
        new LineCollider(new Vector2(50,400), new Vector2(400,400)),
        new LineCollider(new Vector2(400,0), new Vector2(400,400)),
        new LineCollider(new Vector2(400,-550), new Vector2(50,-550)),
        new LineCollider(new Vector2(400,-550), new Vector2(400,-400)),
        new LineCollider(new Vector2(-50,-550), new Vector2(-100,-550)),
        new LineCollider(new Vector2(-100,-850), new Vector2(-100,-550)),
        new LineCollider(new Vector2(-100,-850), new Vector2(400,-850)),
        new LineCollider(new Vector2(400,-850), new Vector2(400,-550)),
        new LineCollider(new Vector2(-100,-850), new Vector2(-75,-850)),
        new LineCollider(new Vector2(400,-850), new Vector2(-25,-850)),
        new LineCollider(new Vector2(400,-850), new Vector2(400,-825)),
        new LineCollider(new Vector2(400,-550), new Vector2(400,-775)),
        new LineCollider(new Vector2(400,-850), new Vector2(400,-900)),
        new LineCollider(new Vector2(400,-900), new Vector2(800,-900)),
        new LineCollider(new Vector2(400,-900), new Vector2(900,-900)),
        new LineCollider(new Vector2(900,-900), new Vector2(900,-350)),
        new LineCollider(new Vector2(900,-350), new Vector2(400,-350)),
        new LineCollider(new Vector2(400,-900), new Vector2(375,-900)),
        new LineCollider(new Vector2(325,-900), new Vector2(-100,-900)),
        new LineCollider(new Vector2(-100,-900), new Vector2(-100,-875)),
        new LineCollider(new Vector2(-100,-900), new Vector2(-100,-925)),
        new LineCollider(new Vector2(-100,-925), new Vector2(-400,-925)),
        new LineCollider(new Vector2(-400,-925), new Vector2(-400,-525)),
        new LineCollider(new Vector2(-400,-525), new Vector2(-100,-525)),
        new LineCollider(new Vector2(-100,-525), new Vector2(-100,-550)),
    ];
}
